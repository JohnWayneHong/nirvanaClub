...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray attr = getContext().obtainStyledAttributes(attrs, com.lihang.R.styleable.ShadowLayout);
        if (attr == null) {
            return;
        }
        ...
        try {
            //默认是显示
            isShowShadow = !attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowHidden, false);
            leftShow = !attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowHiddenLeft, false);
            rightShow = !attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowHiddenRight, false);
            bottomShow = !attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowHiddenBottom, false);
            topShow = !attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowHiddenTop, false);
            mCornerRadius = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_cornerRadius, getResources().getDimension(com.lihang.R.dimen.dp_0));
            mCornerRadius_leftTop = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_cornerRadius_leftTop, -1);
            mCornerRadius_leftBottom = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_cornerRadius_leftBottom, -1);
            mCornerRadius_rightTop = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_cornerRadius_rightTop, -1);
            mCornerRadius_rightBottom = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_cornerRadius_rightBottom, -1);

            //默认扩散区域宽度
            mShadowLimit = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_shadowLimit, 0);
            if (mShadowLimit == 0) {
            ...
            //x轴偏移量
            mDx = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_shadowOffsetX, 0);
            //y轴偏移量
            mDy = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_shadowOffsetY, 0);
            mShadowColor = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_shadowColor, getResources().getColor(com.lihang.R.color.default_shadow_color));

            selectorType = attr.getInt(com.lihang.R.styleable.ShadowLayout_hl_shapeMode, 1);
            isSym = attr.getBoolean(com.lihang.R.styleable.ShadowLayout_hl_shadowSymmetry, true);

            //背景颜色的点击(默认颜色为白色)
            mBackGroundColor = getResources().getColor(com.lihang.R.color.default_shadowback_color);

            Drawable background = attr.getDrawable(com.lihang.R.styleable.ShadowLayout_hl_layoutBackground);
            if (background != null) {
            ...
            Drawable trueBackground = attr.getDrawable(com.lihang.R.styleable.ShadowLayout_hl_layoutBackground_true);
            ...
            //边框颜色的点击
            stroke_color = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_strokeColor, -101);
            stroke_color_true = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_strokeColor_true, -101);

            if (stroke_color == -101 && stroke_color_true != -101) {
                throw new UnsupportedOperationException("使用了ShadowLayout_hl_strokeColor_true属性，必须先设置ShadowLayout_hl_strokeColor属性");
            }

            stroke_with = attr.getDimension(com.lihang.R.styleable.ShadowLayout_hl_strokeWith, dip2px(1));
            //规定边框长度最大不错过7dp
            if (stroke_with > dip2px(7)) {
                stroke_with = dip2px(5);
            }
            ...
            Drawable clickAbleFalseBackground = attr.getDrawable(com.lihang.R.styleable.ShadowLayout_hl_layoutBackground_clickFalse);
            ...
            startColor = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_startColor, -101);
            centerColor = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_centerColor, -101);
            endColor = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_endColor, -101);
            if (startColor != -101) {
                //说明设置了渐变色的起始色
                if (endColor == -101) {
            ...
            angle = attr.getInt(com.lihang.R.styleable.ShadowLayout_hl_angle, 0);
            if (angle % 45 != 0) {
            ...
            mTextViewResId = attr.getResourceId(com.lihang.R.styleable.ShadowLayout_hl_bindTextView, -1);
            textColor = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_textColor, -101);
            textColor_true = attr.getColor(com.lihang.R.styleable.ShadowLayout_hl_textColor_true, -101);
            text = attr.getString(com.lihang.R.styleable.ShadowLayout_hl_text);
            text_true = attr.getString(com.lihang.R.styleable.ShadowLayout_hl_text_true);

            isClickable = attr.getBoolean(com.lihang.R.styleable.ShadowLayout_clickable, true);
