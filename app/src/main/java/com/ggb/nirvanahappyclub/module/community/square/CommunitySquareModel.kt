...
class CommunitySquareModel {
    ...
    fun getCommunitySquareList(pager: Int): LiveData<Resource<List<CommunityAndroidBean.CommunityAndroidListBean>>> {

        HttpUtils.getWanAndroidGatewayApi(ApiService::class.java)
            .getCommunitySquare(pager, AppConfig.ITEM_PAGE_SIZE)
