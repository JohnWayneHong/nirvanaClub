package com.ggb.nirvanahappyclub.module.gpt.viewmodel;
...
import com.ggb.nirvanahappyclub.module.gpt.model.NirvanaGPTMainModel;

import org.jetbrains.annotations.NotNull;


public class NirvanaGPTMainViewModel extends BaseViewModel {
    private final NirvanaGPTMainModel model;
    private final MutableLiveData<String> mSystemExpireTimeLiveData = new ValueKeeperLiveData<>();

    public NirvanaGPTMainViewModel(@NonNull @NotNull Application application) {
        super(application);
        model = new NirvanaGPTMainModel();
    }
