...
@Entity
public class PackageStockInEntity extends BasePackageCodeEntity {
    ...
    @Transient
    private List<PackageStockInEntity> sonList;
    ...
    public void setSonList(List<PackageStockInEntity> sonList) {
        this.sonList = sonList;
    }

    public List<PackageStockInEntity> getSonList() {
        return sonList;
    }
