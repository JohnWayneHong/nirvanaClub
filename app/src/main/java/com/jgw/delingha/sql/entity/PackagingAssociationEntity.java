...
@Entity
public class PackagingAssociationEntity extends BasePackageCodeEntity {
    @Id
    private long id;
    ...
    @Transient
    private List<PackagingAssociationEntity> sonList;
    ...
    public void setSonList(List<PackagingAssociationEntity> sonList) {
        this.sonList = sonList;
    }

    public List<PackagingAssociationEntity> getSonList() {
        return sonList;
    }
