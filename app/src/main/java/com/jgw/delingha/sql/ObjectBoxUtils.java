...
import com.jgw.delingha.sql.entity.MyObjectBox;
...
public class ObjectBoxUtils {
    ...
    public static <T extends BasePackageCodeEntity> List<Class<T>> getPackageEntity() {
        List<Class<T>> list = new ArrayList<>();
        Collection<Class<?>> allEntity = boxStore.getAllEntityClasses();
        for (Class<?> c : allEntity) {
            if (BasePackageCodeEntity.class.isAssignableFrom(c)) {
