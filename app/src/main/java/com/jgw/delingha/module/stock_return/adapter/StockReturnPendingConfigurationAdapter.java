package com.jgw.delingha.module.stock_return.adapter;
 ...
 * description :
 */
public class StockReturnPendingConfigurationAdapter extends CustomRecyclerAdapter<StockReturnPendingConfigurationBean> {
