...
import com.jgw.delingha.module.packaging.in_warehouse.adpter.InWarehousePackageWaitUploadAdapter;
import com.jgw.delingha.module.packaging.in_warehouse.viewmodel.InWarehousePackageWaitUploadViewModel;
 ...
 */
public class InWarehousePackageWaitUploadListActivity extends BaseActivity<InWarehousePackageWaitUploadViewModel, ActivityWaitUploadListBinding> {
    private InWarehousePackageWaitUploadAdapter mAdapter;
    ...
    protected void initData() {
        mAdapter = new InWarehousePackageWaitUploadAdapter();
    ...
    private void showUploadSuccessDialog(UploadResultBean data) {
        ...
        CommonDialogUtil.showSelectDialog(this,"数据上传成功", details, "返回工作台", "查看状态", new CommonDialog.OnButtonClickListener() {
            ...
            public void onLeftClick() {
                MainActivity.start(InWarehousePackageWaitUploadListActivity.this, 0);
            }

            @Override
            public void onRightClick() {
                TaskListActivity.start(TaskListViewModel.TYPE_TASK_IN_WAREHOUSE_PACKAGE, InWarehousePackageWaitUploadListActivity.this);
                finish();
            }
        });
    }
    ...
    public static void start(Context context) {
        if (isActivityNotFinished(context)) {
            Intent intent = new Intent(context, InWarehousePackageWaitUploadListActivity.class);
