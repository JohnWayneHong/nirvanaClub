package com.jgw.delingha.module.packaging.association.adpter;
...
public class PackagingAssociationWaitUploadAdapter extends CustomRecyclerAdapter<PackageConfigEntity> {
