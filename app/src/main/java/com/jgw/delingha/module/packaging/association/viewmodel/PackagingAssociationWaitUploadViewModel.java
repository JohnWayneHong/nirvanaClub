 ...
 * description :
 */
public class PackagingAssociationWaitUploadViewModel extends BaseViewModel {
    ...
    private final MutableLiveData<Boolean> mConfigCodeListLiveData = new ValueKeeperLiveData<>();
    ...
    public PackagingAssociationWaitUploadViewModel(@NonNull Application application) {
        super(application);
    ...
    public void loadConfigCodeList() {
        mConfigCodeListLiveData.setValue(isMix);
    }

    public LiveData<Resource<List<PackageConfigEntity>>> getConfigCodeListLiveData() {
        return Transformations.switchMap(mConfigCodeListLiveData, model::getAllConfigCodeList);
    }
