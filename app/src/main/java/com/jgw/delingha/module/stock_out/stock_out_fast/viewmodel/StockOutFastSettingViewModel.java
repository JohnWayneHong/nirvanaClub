...
public class StockOutFastSettingViewModel extends BaseViewModel {

    private final ConfigInfoModel model;
    private final StockOutFastPDAModel mStockOutFastModel;
    ...
    public StockOutFastSettingViewModel(@NonNull Application application) {
        super(application);
        model = new ConfigInfoModel();
        mStockOutFastModel = new StockOutFastPDAModel();
    }
