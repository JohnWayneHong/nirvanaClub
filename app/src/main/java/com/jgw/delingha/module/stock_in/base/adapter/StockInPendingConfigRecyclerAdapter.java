package com.jgw.delingha.module.stock_in.base.adapter;
...
public class StockInPendingConfigRecyclerAdapter extends CustomRecyclerAdapter<ConfigurationSelectBean> {

    public StockInPendingConfigRecyclerAdapter() {
