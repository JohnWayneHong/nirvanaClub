 ...
 * description :
 */
public class StockReturnSettingViewModel extends BaseViewModel {
    ...
    public StockReturnSettingViewModel(@NonNull Application application) {
        super(application);
    ...
    public LiveData<Resource<ConfigurationEntity>> getConfigLiveData() {
        return Transformations.switchMap(mConfigIdLiveData, mConfigModel::getConfigInfo);
    }
    ...
    public LiveData<Resource<WareHouseEntity>> getWareHouseInfoLiveData() {
        return Transformations.switchMap(mGetWareHouseLiveData, mConfigModel::getWareHouseInfoEntity);
    }
    ...
    public LiveData<Resource<StorePlaceEntity>> getStorePlaceInfoLiveData() {
        return Transformations.switchMap(mGetStorePlaceLiveData, mConfigModel::getStorePlaceInfoEntity);
    }
