...
import com.jgw.delingha.module.stock_out.stock_out_fast.adapter.StockOutFastWaitUploadListRecyclerAdapter;
import com.jgw.delingha.module.stock_out.stock_out_fast.viewmodel.StockOutFastWaitUploadViewModel;
 ...
 * 出库待执行列表
 */
public class StockOutFastWaitUploadListActivity extends BaseActivity<StockOutFastWaitUploadViewModel, ActivityStockOutFastWaitUploadBinding> {

    private StockOutFastWaitUploadListRecyclerAdapter mAdapter;
    ...
    protected void initData() {
        setTitle("待执行直接出库");
        mAdapter = new StockOutFastWaitUploadListRecyclerAdapter();
    ...
    private void onDeleteClick() {
        ...
        CommonDialogUtil.showSelectDialog(this,"是否确定删除?", "", "取消", "删除", new CommonDialog.OnButtonClickListener() {
            ...
            @Override
            public void onRightClick() {
                mViewModel.deleteSelectItem(mAdapter);
                calculationTotal();
            }
        });
    }
    ...
    public void onItemClick(View view, int position) {
        ...
        if (id == R.id.ll_stock_out_wait_upload_list_item) {
            CommonScanBackActivity.start(this, 1,  CommonScanBackActivity.TYPE_STOCK_OUT_FAST, bean.config_id);
    ...
    public void showUploadSuccessDialog(UploadResultBean data) {
        ...
        CommonDialogUtil.showSelectDialog(this,"数据上传成功", details, "返回工作台", "查看状态", new CommonDialog.OnButtonClickListener() {
            ...
            public void onLeftClick() {
                MainActivity.start(StockOutFastWaitUploadListActivity.this, 0);
            }

            @Override
            public void onRightClick() {
                TaskListActivity.start(TaskListViewModel.TYPE_TASK_STOCK_OUT, StockOutFastWaitUploadListActivity.this);
                finish();
            }
        });
    }
    ...
    public static void start(Context context) {
        if (BaseActivity.isActivityNotFinished(context)) {
            Intent intent = new Intent(context, StockOutFastWaitUploadListActivity.class);
