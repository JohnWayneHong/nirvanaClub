 ...
 * description :
 */
public class PackagingAssociationViewModel extends BaseViewModel {

    private PackagingAssociationModel model;
    ...
    private final MutableLiveData<PackagingAssociationEntity> mShowBoxListLiveData = new ValueKeeperLiveData<>();
    ...
    private List<PackagingAssociationEntity> mCodeList;//用于页面展示子码列表
    private long mConfigId;

    public PackagingAssociationViewModel(@NonNull Application application) {
        super(application);
        model = new PackagingAssociationModel();
        mConfigModel = new PackageConfigInfoModel();
    }

    public void setDataList(List<PackagingAssociationEntity> dataList) {
        mCodeList = dataList;
    }
    ...
    public LiveData<Resource<Integer>> getUpdateStatisticsCountLiveData() {
    ...
    public void checkBoxCode(String code) {
        ...
        bean.packageSceneType = mConfigEntity.getPackageSceneType();
    ...
    public void checkSonCode(String sonCode, CodeEntityRecyclerAdapter<PackagingAssociationEntity> adapter, CustomBaseRecyclerView recyclerView) {
        PackagingAssociationEntity entity = new PackagingAssociationEntity();
    ...
    public LiveData<Resource<PackagingAssociationEntity>> getCheckCodeLiveData() {
    ...
    public LiveData<Resource<PackagingAssociationEntity>> getShowBoxListLiveData() {
    ...
    public LiveData<Resource<List<PackagingAssociationEntity>>> getRefreshBoxListLiveData() {
    ...
    public boolean isRepeatCode(String code) {
        PackagingAssociationEntity entity = model.queryEntityByCode(code);
        if (entity != null) {
    ...
    public Spanned getBoxCodeCountStatistics(int boxCount) {
        String firstNumberName = mConfigEntity.getFirstNumberName();
