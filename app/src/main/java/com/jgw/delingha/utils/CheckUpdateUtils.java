...
import com.jgw.delingha.bean.SaveFileBean;
import com.jgw.delingha.bean.VersionBean;
import com.jgw.delingha.bean.VersionTypeBean;
...
public class CheckUpdateUtils implements View.OnClickListener {
    ...
    public void startUpdate() {
        WaitUploadMenuModel model = new WaitUploadMenuModel();
        if (model.hasExistWaitUploadData()) {
            CommonDialogUtil.showSelectDialog(mActivity, "警告", "当前有码未上传,继续更新可能清空数据", "前往上传", "继续更新",
                    new CommonDialog.OnButtonClickListener() {
                        @Override
                        public void onLeftClick() {
                            WaitUploadMenuActivity.start(dialog.getOwnerActivity());
                        }
