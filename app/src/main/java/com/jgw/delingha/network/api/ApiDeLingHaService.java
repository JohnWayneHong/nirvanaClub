...
//    @GET("hydra-breed-pig/api/pig/variety/series/get-variety")
     ...
     * 养殖进场记录详情
     */
    @GET("hydra-breed-pig/pda/breed/in/detail")
    Observable<HttpResult<BreedInDetailsBean>> getBreedInDetails(@Query("breedInRecId") String breedInRecId);
     ...
     * 入栏信息记录列表详情
     */
    @GET("hydra-breed-pig/pda/in/fence/detail")
    Observable<HttpResult<EnterFenceDetailsBean>> getEnterFenceDetails(@Query("inFenceId") String inFenceId);
     ...
     * 根据耳号，栏舍Id获取养殖批次号
     */
    @GET("hydra-breed-pig/pda/identification/association/get/batch/fenceId")
    Observable<HttpResult<BreedInAssociateBean>> getBatchByCodeAndFence(@QueryMap Map<String, Object> map);

    /**
     * 根据耳号,获取养殖批次号
     */
    @GET("hydra-breed-pig/pda/identification/association/get/batch")
    Observable<HttpResult<BreedInAssociateBean>> getBatchByCode(@QueryMap Map<String, Object> map);
     ...
     * 养殖离场记录详情
     */
    @GET("hydra-breed-pig/pda/breed/out/rec/detail")
    Observable<HttpResult<BreedOutDetailsBean>> getBreedOutDetails(@Query("breedOutRecId") String breedInRecId);
     ...
     * 屠宰进场记录详情
     */
    @GET("hydra-butcher/pda/in-factory/dlh/detail")
    Observable<HttpResult<SlaughterInDetailsBean>> getSlaughterInDetails(@Query("inFactoryId") String breedInRecId);
     ...
     * 称重记录 详情
     */
    @GET("hydra-butcher/pda/weigh/dlh/detail")
    Observable<HttpResult<SlaughterWeighingDetailsListBean>> getSlaughterWeighingDetails(@Query("id") String breedInRecId);
...
//    @GET("hydra-butcher/pda/processing-approach/record/list")
     ...
     * 加工进场记录详情
     */
    @GET("hydra-butcher/pda/processing-approach/record/detail")
    Observable<HttpResult<ProcessingApproachInDetailsBean>> getProcessingApproachInDetails(@Query("processingId") String breedInRecId);
     ...
     * 转栏管理记录详情
     */
    @GET("hydra-breed-pig/pda/dlh/rotation-rail/detail")
    Observable<HttpResult<ExchangePigstyDetailsBean>> getExchangePigstyDetails(@Query("fenceTransferId") String breedInRecId);
