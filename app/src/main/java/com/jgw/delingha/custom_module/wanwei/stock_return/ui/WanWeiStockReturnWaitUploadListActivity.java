...
import com.jgw.delingha.custom_module.wanwei.stock_return.adapter.WanWeiStockReturnPendingConfigurationAdapter;
import com.jgw.delingha.custom_module.wanwei.stock_return.viewmodel.WanWeiStockReturnWaitUploadViewModel;
 ...
 */
public class WanWeiStockReturnWaitUploadListActivity extends BaseActivity<WanWeiStockReturnWaitUploadViewModel, ActivityWaitUploadListBinding> implements OnItemSingleClickListener {

    private WanWeiStockReturnPendingConfigurationAdapter mAdapter;
    ...
    protected void initData() {
        ...
        mAdapter = new WanWeiStockReturnPendingConfigurationAdapter();
    ...
    public void onItemClick(View view, int position) {
        ...
        if (id == R.id.iv_select) {
            ...
            CommonScanBackActivity.start(this, 1, CommonScanBackActivity.TYPE_WANWEI_STOCK_RETURN, mAdapter.getDataList().get(position).id);
        }
    }
    ...
    private void showUploadFinishDialog(UploadResultBean data) {
        ...
        CommonDialogUtil.showSelectDialog(this,"数据上传成功", details, "返回工作台", "查看状态", new CommonDialog.OnButtonClickListener() {
            ...
            public void onLeftClick() {
                MainActivity.start(WanWeiStockReturnWaitUploadListActivity.this, 0);
            }
    ...
    public static void start(Context context) {
        if (isActivityNotFinished(context)) {
            Intent intent = new Intent(context, WanWeiStockReturnWaitUploadListActivity.class);
