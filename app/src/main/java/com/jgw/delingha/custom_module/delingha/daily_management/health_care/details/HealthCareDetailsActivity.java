 ...
 * @author : hwj
 * @date : 2023/8/4
 * description : 保健记录 详情 Activity
 */
public class HealthCareDetailsActivity extends BaseActivity<HealthCareDetailsViewModel, ActivityCommonInfoDetailsBinding> {
    ...
    public void onInfoDetailsItemClick(InfoDetailsClickBean clickBean) {
        ...
        switch (data.key) {
            case "栏舍号":
                ...
                break;
            case "保健日期":
                PickerUtils.showTimePicker(this, time -> update("保健日期", new InfoDetailsDemoBean.ValueBean(time, null)));
                break;
            case "类型":
                CommonSelectListActivity.start(102, this, CommonSelectListActivity.BREED_TASK_TYPE);
                break;
            case "保健对象":
