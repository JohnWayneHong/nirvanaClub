 ...
 * @author : hwj
 * @date : 2023/8/4
 * description : 免疫记录 详情 Activity
 */
public class ImmunityDetailsActivity extends BaseActivity<ImmunityDetailsViewModel, ActivityCommonInfoDetailsBinding> {
    ...
    public void onInfoDetailsItemClick(InfoDetailsClickBean clickBean) {
        ...
        switch (data.key) {
            case "栏舍号":
                ...
                break;
            case "免疫日期":
                PickerUtils.showTimePicker(this, time -> update("免疫日期", new InfoDetailsDemoBean.ValueBean(time, null)));
                break;
            case "类型":
    ...
    public static void start(Activity context, int requestCode) {
        if (isActivityNotFinished(context)) {
            ...
            Intent intent = new Intent(context, ImmunityDetailsActivity.class);
