package com.jgw.delingha.custom_module.delingha.daily_management.health_care.details;
 ...
 * @author : hwj
 * @date : 2023/8/4
 * description : 保健记录 详情 ViewModel
 */
public class HealthCareDetailsViewModel extends BaseViewModel {
    private final HealthCareDetailsModel model;
    ...
    public HealthCareDetailsViewModel(@NonNull Application application) {
        super(application);
        model = new HealthCareDetailsModel();
    }
    ...
    public void submit(InfoDetailsRecyclerAdapter adapter) {
        ...
        map.put("animalsId", adapter.searchValueIdByKey("保健对象"));
        map.put("animalsValue", adapter.searchValueStrByKey("保健对象"));
        map.put("healthCareTime", adapter.searchValueStrByKey("保健日期"));
        map.put("healthCareNumber", adapter.searchValueStrByKey("保健数量"));
