...
import com.jgw.delingha.custom_module.delingha.daily_management.energy.details.EnergyDetailsActivity;
 ...
 * 能耗记录列表
 */
public class EnergyListActivity extends BaseActivity<EnergyListViewModel, ActivityCommonSelectListButtonBinding> implements SwipeRefreshLayout.OnRefreshListener {

    private EditText searchView;
    private EnergyListRecyclerAdapter mAdapter;
    ...
    protected void initData() {
        setTitle("能耗记录");
        mAdapter = new EnergyListRecyclerAdapter();
...
//        });
    ...
    public void onClick(View view) {
        ...
        if (id == mBindingView.tvSelectCommonBottomButton.getId()) {
            EnergyDetailsActivity.start(this, 1);
        }
    }
...
//        if (id == R.id.tv_energy_list_details) {
//            mViewModel.getSlaughterInDetails(id1);
//        } else
        if (id == R.id.tv_energy_list_delete) {
    ...
    public static void start(Context context) {
        if (BaseActivity.isActivityNotFinished(context)) {
            Intent intent = new Intent(context, EnergyListActivity.class);
