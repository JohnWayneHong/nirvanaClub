...
import com.jgw.delingha.custom_module.maogeping.packaging_association_custom.viewmodel.PackagingAssociationCustomSettingViewModel;
 ...
 * description : 包装关联设置
 */
public class PackagingAssociationCustomSettingActivity extends BaseActivity<PackagingAssociationCustomSettingViewModel, ActivityPackagingAssociationSettingBinding> {
        ...
        mViewModel.getSaveConfigLiveData().observe(this, resource -> {
            switch (resource.getLoadingStatus()) {
                case Resource.SUCCESS:
                    ...
                    PackagingAssociationCustomActivity.start(PackagingAssociationCustomSettingActivity.this, configId);
                    finish();
                    break;
                case Resource.ERROR:
                    ToastUtils.showToast(resource.getErrorMsg());
        ...
        CommonDialogUtil.showSelectDialog(this,"您有待执行任务未提交", "是否前往待执行页面",
                "取消", "确定", new CommonDialog.OnButtonClickListener() {
                    ...
                    public void onRightClick() {
                        PackagingAssociationCustomWaitUploadListActivity.start(PackagingAssociationCustomSettingActivity.this);
                        finish();
                    }
                });
    }
    ...
    public static void start(Context context) {
        if (isActivityNotFinished(context)) {
            Intent intent = new Intent(context, PackagingAssociationCustomSettingActivity.class);
