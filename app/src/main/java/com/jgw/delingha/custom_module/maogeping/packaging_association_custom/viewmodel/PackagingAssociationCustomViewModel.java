 ...
 * description :
 */
public class PackagingAssociationCustomViewModel extends BaseViewModel {
    ...
    private final MutableLiveData<PackagingAssociationCustomEntity> mShowBoxListLiveData = new ValueKeeperLiveData<>();
    ...
    private List<PackagingAssociationCustomEntity> mCodeList;//用于页面展示子码列表
    private long mConfigId;

    public PackagingAssociationCustomViewModel(@NonNull Application application) {
        super(application);
        model = new PackagingAssociationCustomModel();
        mConfigModel = new PackageConfigInfoModel();
    }

    public void setDataList(List<PackagingAssociationCustomEntity> dataList) {
        mCodeList = dataList;
    }
    ...
    public void checkSonCode(String sonCode, CodeEntityRecyclerAdapter<PackagingAssociationCustomEntity> adapter, CustomBaseRecyclerView recyclerView) {
        PackagingAssociationCustomEntity entity = new PackagingAssociationCustomEntity();
    ...
    public LiveData<Resource<PackagingAssociationCustomEntity>> getCheckCodeLiveData() {
    ...
    public LiveData<Resource<PackagingAssociationCustomEntity>> getShowBoxListLiveData() {
    ...
    public LiveData<Resource<List<PackagingAssociationCustomEntity>>> getRefreshBoxListLiveData() {
    ...
    public boolean isRepeatCode(String code) {
        PackagingAssociationCustomEntity entity = model.queryEntityByCode(code);
        if (entity != null) {
