 ...
 * description :
 */
public class WanWeiStockReturnWaitUploadViewModel extends BaseViewModel {
    ...
    private List<StockReturnPendingConfigurationBean> mList = new ArrayList<>();

    public WanWeiStockReturnWaitUploadViewModel(@NonNull Application application) {
        super(application);
