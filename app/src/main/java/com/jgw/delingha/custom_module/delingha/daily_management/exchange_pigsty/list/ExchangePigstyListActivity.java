...
import com.jgw.delingha.custom_module.delingha.daily_management.exchange_pigsty.details.ExchangePigstyDetailsActivity;
import com.jgw.delingha.custom_module.delingha.daily_management.weight.details.WeightDetailsActivity;
 ...
 * 称重记录列表
 */
public class ExchangePigstyListActivity extends BaseActivity<ExchangePigstyListViewModel, ActivityCommonSelectListButtonBinding> implements SwipeRefreshLayout.OnRefreshListener {

    private EditText searchView;
    private ExchangePigstyListRecyclerAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mBindingView.tvSelectCommonBottomButton.setText("新增");
    }

    @Override
    protected void initData() {
        setTitle("转栏记录");
        mAdapter = new ExchangePigstyListRecyclerAdapter();
    ...
    public void initLiveData() {
        ...
        mViewModel.getDetailsLiveData().observe(this, resource -> {
            switch (resource.getLoadingStatus()) {
                case Resource.LOADING:
                    showLoadingDialog();
                    break;
                case Resource.SUCCESS:
                    ...
                    ExchangePigstyDetailsActivity.start(this, resource.getData());
                    break;
                case Resource.ERROR:
                    dismissLoadingDialog();
                    break;
    ...
    public void onClick(View view) {
        ...
        if (id == mBindingView.tvSelectCommonBottomButton.getId()) {
            ExchangePigstyDetailsActivity.start(this, 1);
        }
    }
    ...
    public void onItemClick(View view, int position) {
        ...
        String id1 = selectItemSupport.getStringItemId();
        if (id == R.id.tv_exchange_pigsty_list_details) {
            mViewModel.getDetails(id1);
        }
//        else
//        if (id == R.id.tv_weight_list_delete) {
...
//        }
    ...
    public static void start(Context context) {
        if (BaseActivity.isActivityNotFinished(context)) {
            Intent intent = new Intent(context, ExchangePigstyListActivity.class);
