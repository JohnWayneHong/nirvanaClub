...
import com.jgw.delingha.custom_module.delingha.daily_management.feeding.details.FeedingDetailsActivity;
 ...
 * 饲喂记录列表
 */
public class FeedingListActivity extends BaseActivity<FeedingListViewModel, ActivityCommonSelectListButtonBinding> implements SwipeRefreshLayout.OnRefreshListener {

    private EditText searchView;
    private FeedingListRecyclerAdapter mAdapter;
    ...
    protected void initData() {
        setTitle("饲喂记录");
        mAdapter = new FeedingListRecyclerAdapter();
...
//                    FeedingDetailsActivity.start(this, resource.getData());
//                    break;
//                case Resource.ERROR:
//                    dismissLoadingDialog();
//                    break;
...
//        });
    ...
    public void onClick(View view) {
        ...
        if (id == mBindingView.tvSelectCommonBottomButton.getId()) {
            FeedingDetailsActivity.start(this, 1);
        }
    }
...
//        if (id == R.id.tv_feeding_list_details) {
//            mViewModel.getSlaughterInDetails(id1);
//        } else
        if (id == R.id.tv_feeding_list_delete) {
    ...
    public static void start(Context context) {
        if (BaseActivity.isActivityNotFinished(context)) {
            Intent intent = new Intent(context, FeedingListActivity.class);
