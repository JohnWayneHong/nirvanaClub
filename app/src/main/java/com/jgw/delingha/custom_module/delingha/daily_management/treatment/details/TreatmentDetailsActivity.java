 ...
 * @author : hwj
 * @date : 2023/8/4
 * description : 诊疗记录 详情 Activity
 */
public class TreatmentDetailsActivity extends BaseActivity<TreatmentDetailsViewModel, ActivityCommonInfoDetailsBinding> {
    ...
    public void onInfoDetailsItemClick(InfoDetailsClickBean clickBean) {
        ...
        switch (data.key) {
            case "栏舍号":
                ...
                break;
            case "诊疗日期":
                PickerUtils.showTimePicker(this, time -> update("诊疗日期", new InfoDetailsDemoBean.ValueBean(time, null)));
                break;
            case "类型":
