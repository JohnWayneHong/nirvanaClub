 ...
 * @author : hwj
 * @date : 2023/8/4
 * description : 保健记录 详情 Model
 */
public class HealthCareDetailsModel {

    private final ImageUploadModel uploadModel;

    public HealthCareDetailsModel() {
...
//
    ...
    private ValueKeeperLiveData<Resource<String>> mHealthCareLiveData;

    public LiveData<Resource<String>> postUpload(Map<String, Object> map) {
        if (mHealthCareLiveData == null) {
            mHealthCareLiveData = new ValueKeeperLiveData<>();
        }
        ...
        uploadObservable.subscribe(new CustomObserver<String>(mHealthCareLiveData) {
        });
        return mHealthCareLiveData;
    }
