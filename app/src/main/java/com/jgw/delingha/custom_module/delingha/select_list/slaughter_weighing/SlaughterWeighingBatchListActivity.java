...
public class SlaughterWeighingBatchListActivity extends BaseSelectItemListActivity<SlaughterWeighingBatchListViewModel, ActivityCommonSelectListBinding> {
    public static final String TAG = "SlaughterWeighingBatchListActivity";

    public static final String TAG_DATA = "SlaughterWeighingBatchListActivityData";
    ...
    public static void start(Activity context, int requestCode, String titleName) {
        if (isActivityNotFinished(context)) {
            Intent intent = new Intent(context, SlaughterWeighingBatchListActivity.class);
