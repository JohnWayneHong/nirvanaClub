...
//
    ...
    private ValueKeeperLiveData<Resource<String>> mTreatmentLiveData;

    public LiveData<Resource<String>> postUpload(Map<String, Object> map) {
        if (mTreatmentLiveData == null) {
            mTreatmentLiveData = new ValueKeeperLiveData<>();
        }
        ...
        uploadObservable.subscribe(new CustomObserver<String>(mTreatmentLiveData) {
        });
        return mTreatmentLiveData;
    }
