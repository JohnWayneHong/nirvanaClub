 ...
 * @Description 养殖进场 新增记录 ViewModel
 */
public class BreedInAddViewModel extends BaseViewModel {
    private final BreedInAddModel model;
    ...
    public BreedInAddViewModel(@NonNull Application application) {
        super(application);
        model = new BreedInAddModel();
    }
