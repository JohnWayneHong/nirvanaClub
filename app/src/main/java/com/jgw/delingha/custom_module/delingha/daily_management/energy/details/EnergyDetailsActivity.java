 ...
 * @Description 能耗详情
 */
public class EnergyDetailsActivity extends BaseActivity<EnergyDetailsViewModel, ActivityCommonInfoDetailsBinding> {
...
//    }
    ...
    public static void start(Activity context, int requestCode) {
        if (isActivityNotFinished(context)) {
            ...
            Intent intent = new Intent(context, EnergyDetailsActivity.class);
