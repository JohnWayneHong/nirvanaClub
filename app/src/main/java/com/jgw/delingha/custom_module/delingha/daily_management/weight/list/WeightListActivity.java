 ...
 * 称重记录列表
 */
public class WeightListActivity extends BaseActivity<WeightListViewModel, ActivityCommonSelectListButtonBinding> implements SwipeRefreshLayout.OnRefreshListener {

    private EditText searchView;
    private WeightListRecyclerAdapter mAdapter;
    ...
    protected void initData() {
        setTitle("称重记录");
        mAdapter = new WeightListRecyclerAdapter();
...
//        });
    ...
    public void onClick(View view) {
        ...
        if (id == mBindingView.tvSelectCommonBottomButton.getId()) {
            WeightDetailsActivity.start(this, 1);
        }
    }
