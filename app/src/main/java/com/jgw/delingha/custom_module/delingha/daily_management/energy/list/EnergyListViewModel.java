 ...
 * on 2020/7/7
 */
public class EnergyListViewModel extends BaseViewModel {
    private final EnergyListModel model;
...
//    private final MutableLiveData<String> mSlaughterInDetailsLiveData = new MutableLiveData<>();
    ...
    public EnergyListViewModel(@NonNull Application application) {
        super(application);
        model = new EnergyListModel();
    }
