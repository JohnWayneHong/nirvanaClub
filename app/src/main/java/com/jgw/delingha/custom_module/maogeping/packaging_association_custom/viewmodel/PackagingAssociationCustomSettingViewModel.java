 ...
 */
public class PackagingAssociationCustomSettingViewModel extends BaseViewModel {
    ...
    public PackagingAssociationCustomSettingViewModel(@NonNull Application application) {
        super(application);
    ...
    public LiveData<Resource<List<Long>>> getCheckWaitUploadLiveData() {
        return Transformations.switchMap(mCheckWaitUploadLiveData, input -> model.checkWaitUpload());
    }
